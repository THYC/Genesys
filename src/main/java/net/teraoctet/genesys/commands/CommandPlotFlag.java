    ...
    public CommandResult execute(CommandSource src, CommandContext ctx) throws CommandException {
        ...
        if(src instanceof Player && src.hasPermission("genesys.plot.flag")) { 
            ...
            if (gplot == null){
                ...
                player.sendMessage(ChatTypes.CHAT,USAGE("/plot flag <flag> <0|1> : modifie la valeur &6Oui = 1 Non = 0, vous devez \352tre sur la parcelle"));
            ...
            if(!ctx.getOne("flag").isPresent()){
                ...
                switch (flag.toLowerCase()){
                    case "noenter":
                        ...
                        player.sendMessage(ChatTypes.CHAT,MESSAGE("&7Flag enregistr\351 : &enoEnter = " + value));
                        break;
                    case "nofly":
                        gplot.setNoFly(value);
                        player.sendMessage(ChatTypes.CHAT,MESSAGE("&7Flag enregistr\351 : &enoFly = " + value));
                        break;
                    case "nobuild":
                        gplot.setNoBuild(value);
                        player.sendMessage(ChatTypes.CHAT,MESSAGE("&7Flag enregistr\351 : &enoBuild = " + value));
                        break;
                    case "nobreak":
                        gplot.setNoBreak(value);
                        player.sendMessage(ChatTypes.CHAT,MESSAGE("&7Flag enregistr\351 : &enoBreak = " + value));
                        break;
                    case "nointeract":
                        gplot.setNoInteract(value);
                        player.sendMessage(ChatTypes.CHAT,MESSAGE("&7Flag enregistr\351 : &enoInteract = " + value));
                        break;
                    case "noteleport":
                        gplot.setNoTeleport(value);
                        player.sendMessage(ChatTypes.CHAT,MESSAGE("&7Flag enregistr\351 : &enoTeleport = " + value));
                        break;
                    case "nofire":
                        gplot.setNoFire(value);
                        player.sendMessage(ChatTypes.CHAT,MESSAGE("&7Flag enregistr\351 : &enoFire = " + value));
                        break;
                    case "nomob":
                        gplot.setNoMob(value);
                        player.sendMessage(ChatTypes.CHAT,MESSAGE("&7Flag enregistr\351 : &enoMob = " + value));
                        break;
                    case "notnt":
                        gplot.setNoTNT(value);
                        player.sendMessage(ChatTypes.CHAT,MESSAGE("&7Flag enregistr\351 : &enoTNT = " + value));
                        break;
                    case "nocommand":
                        gplot.setNoCommand(value);
                        player.sendMessage(ChatTypes.CHAT,MESSAGE("&7Flag enregistr\351 : &enoCommand = " + value));
                        break;
                }
                gplot.update();
                GData.commit();
