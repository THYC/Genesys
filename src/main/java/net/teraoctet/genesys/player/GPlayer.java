...
public class GPlayer {
	...
	public GPlayer(String uuid, int level, String name, String godmode, double flymode, String mails, double money, String lastposition, String lastdeath, double onlinetime, double lastonline) {
            this.uuid = uuid;
            this.level = level;
            this.name = name;
